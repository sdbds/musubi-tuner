...
def save_text_encoder_output_cache_common(
    ...
    *,
    ...
    if extra_metadata is not None and additional_metadata is not None:
        raise ValueError("Specify only one of extra_metadata or additional_metadata")
    metadata_input = additional_metadata if additional_metadata is not None else extra_metadata
    ...
    metadata = _merge_cache_metadata(required_metadata, metadata_input)
    ...
    metadata = _merge_cache_metadata(required_metadata, metadata)
