...
class MiniMaxH3NetworkTrainer(NetworkTrainer):
    ...
    def _prepare_training_state(
        ...
        # Draw all condition augmentation once so every best-of-K candidate sees
        # the same student and teacher conditions.
    ...
    def process_batch(
        ...
        state = self._prepare_training_state(args, batch, latents, network)
